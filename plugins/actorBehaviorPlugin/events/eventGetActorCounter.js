...
export const id = "EVENT_GET_ACTOR_COUNTER";
export const name = "Get actor counter";
export const groups = ["EVENT_GROUP_ACTOR"];

export const autoLabel = (fetchArg) => {
  return `Get actor counter`;
};
...
export const compile = (input, helpers) => {
  ...
  _addComment("Set actor counter");
    
  _stackPushConst(variableAlias);
  _stackPush(tmp0);
  		
  _callNative("vm_get_actor_counter");
  _stackPop(2);   
