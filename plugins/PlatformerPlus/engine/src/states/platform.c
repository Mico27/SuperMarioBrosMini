...
void platform_update(void) BANKED {
    ...
    switch(plat_state){
        ...
        case JUMP_STATE:
            ...
            break;
        case VINE_INIT:
			que_state = VINE_STATE;
		case VINE_STATE:
			break;
		case PIPE_INIT:
			que_state = PIPE_STATE;
		case PIPE_STATE:
			break;
		case POLE_INIT:
			que_state = POLE_STATE;
		case POLE_STATE:
			break;
		case CHANGESIZE_INIT:
			que_state = CHANGESIZE_STATE;
		case CHANGESIZE_STATE:
			break;
		case DEAD_INIT:
		...
		case FIREFLOWER_STATE:
			break;
		case END_LEVEL_INIT:
			que_state = END_LEVEL_STATE;
		case END_LEVEL_STATE:
			break;
        case BLANK_INIT:
