...
#define ANIM_STATE_1UP 4
#define ANIM_STATE_SWIM 5
#define ANIM_STATE_CHANGESIZE 6
#define ANIM_STATE_SKID 7
#define ANIM_STATE_CLIMB 8
#define ANIM_STATE_CROUCH 9
#define ANIM_STATE_PIPETRANSITION 10
#define ANIM_STATE_STATIC 11
