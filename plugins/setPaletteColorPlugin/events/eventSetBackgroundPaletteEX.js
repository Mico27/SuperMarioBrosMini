...
export const id = "EVENT_PALETTE_SET_BACKGROUND_EX";
export const name = l10n("EVENT_PALETTE_SET_BACKGROUND") + " EX";
export const groups = ["EVENT_GROUP_COLOR"];

export const autoLabel = (fetchArg) => {
  return l10n("EVENT_PALETTE_SET_BACKGROUND") + " EX";;
};
...
export const compile = (input, helpers) => {
  ...
  const paletteIds = [
    ...
    const { palettes, settings, scene } = options;
    ...
    _paletteLoad(mask, ".PALETTE_BKG", input.commit);
